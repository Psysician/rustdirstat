...
| ---- | ---- | ------------ |
| `milestones.md` | MS1-MS21 roadmap with deliverables and dependency graph | Understanding planned feature scope, checking milestone status |
| `benchmarks.md` | Memory usage audit, scan throughput data, treemap rendering budget, Criterion benchmark results | Reviewing performance characteristics, understanding memory projections |
